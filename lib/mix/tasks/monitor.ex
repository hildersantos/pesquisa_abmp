# lib/mix/tasks/monitor.ex
defmodule Mix.Tasks.Monitor do
  use Mix.Task

  @host System.get_env("MIX_MONITOR_HOST")
  @user System.get_env("MIX_MONITOR_USER")
  @ssh_pass_phrase System.get_env("MIX_MONITOR_SSH_PASS_PHRASE")
  @app_cookie "_pesquisa_abmp_key"

  def run(_) do
    :ssh.start
    case SSHEx.connect(ip: to_charlist(@host), user: to_charlist(@user), rsa_pass_phrase: to_charlist(@ssh_pass_phrase)) do
